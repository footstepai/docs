...
A list of matching places, each with coordinates, name, full label, distance from the search point in meters, and (when below 1.0) a confidence score. Results are sorted by proximity.
